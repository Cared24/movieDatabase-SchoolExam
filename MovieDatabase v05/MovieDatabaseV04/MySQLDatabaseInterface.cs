...
namespace MovieDatabaseV04
{
    class MySQLDatabaseInterface
    {
        ...
        public bool makeConnectionToDatabase()
        {
            ...
            {
                setErrorDataAndShow("Database connection failed");
            }
            return true;
            ...
            else
            {
                ...
                else
                {
                    ...
                    catch (MySqlException me)
                    {
                        ...
                        {
                            case 0:
                                setErrorDataAndShow("Cannot connect to server." + me.Message);
                                break;

                            case 1045:
                                setErrorDataAndShow("Invalid username/password, please try again.");
                                break;

                            case 1042:
                                setErrorDataAndShow("Message: Can't get hostname for your address ");
                                break;

                            default:
                                setErrorDataAndShow("Cannot connect to server.\n" +
        ...
        public bool close()
        {
            ...
            {
                setErrorDataAndShow("Error during server closing\n" +
                                                    e.Message/*+me.Number*/
                                                    );
                return false;
            }
